...
> - 레지스트리를 수정하므로 문제 발생 시 `Undo Focused` 또는 `Reset Focused`로 즉시 되돌릴 수 있습니다.
...
| 버튼 | 동작 |
|---|---|
| **Undo Focused** | 현재 포커스(단일) 장치의 마지막 변경을 이전 상태로 되돌립니다 |
| **Reset Focused** | 현재 포커스(단일) 장치의 모든 커스텀 IRQ 값을 제거합니다 |
